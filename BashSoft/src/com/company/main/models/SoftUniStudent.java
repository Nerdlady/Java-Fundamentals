...
import com.company.main.exceptions.KeyNotFoundException;
...
public class SoftUniStudent implements Student {
   ...
   private LinkedHashMap<String,Double> marksByCourseName;
    ...
    private double calculateMark(int[] scores) {
        double percentageOfSolvedExam = Arrays.stream(scores).sum() / (double) (SoftUniCourse.NUMBER_OF_TASK_ON_EXAM * SoftUniCourse.MAX_SCORE_ONE_EXAM_TASK);
